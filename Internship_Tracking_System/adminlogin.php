				...
				<div class="container">
					...
					<!-- Banner -->
						<div id="banner">
							<header id="header">
								<div class="inner">
									<h1><strong><a href="adminlogin.php" style="color: white; font-size: 30px;text-align: center">LOGIN</a></strong></h1>
							...
							if (isset($_POST['submit']))
							{
								...
								$sqlLoginCheck = "SELECT * FROM `login_details` WHERE person_id='$userName' and password='$password' and person_type='A'";
