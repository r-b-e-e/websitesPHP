				...
				<div class="container">
					...
					<!-- Banner -->
						<div id="banner">
							<header id="header">
								<div class="inner">
									<h1><strong style="color: white; font-size: 30px;text-align: center">SEARCH STUDENT SKILLS</strong></h1>
							...
							?>
									...
									<?php echo "Please enter Student Id!!"; ?>
									</div>
							<?php
								}
								...
								else 
								{
									...
									$sqlRetrieveName = "SELECT first_name, middle_name, last_name FROM PERSON_DETAILS WHERE person_id='$personId'";
									$nameResult = mysqli_query($dbcon, $sqlRetrieveName);
									$count1 = mysqli_num_rows($nameResult);
									if($count1 == 0){
								?>
								    <div class="alert-box error">
								...
								<?php
									  ...
									  $sql="SELECT SD.SKILL_NAME,SK.LEVEL FROM STUDENT_SKILL SK, SKILLS_DETAILS SD WHERE SK.PERSON_ID='$personId' AND SK.SKILL_ID = SD.SKILL_ID";
			...
			<div class="inner">
	            ...
	            <?php
                  if($row=mysqli_fetch_assoc($nameResult)){
					  echo "Student Name : ".$row['first_name']." ".$row['middle_name']." ".$row['last_name'];
				  }				
                ?>				
			</h1>
			...
			<div>
				<table style="border: 2px solid red; text-align: center; border-collapse: collapse;">
					<tr style="font-size: 20px; font-weight: bold; color: white">
						<th style="border: 1px solid white;">Skill</th>
					...
					<tr style="border: 1px solid red; color: white">
						<td style="border: 1px solid white;"><?php echo $row['SKILL_NAME']; ?></td>
						<td style="border: 1px solid white;"><?php echo $row['LEVEL']; ?></td>
					</tr>
					<?php 						
					}						
					?>
